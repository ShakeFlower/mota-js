...
### 2022.7.10 HTML5魔塔魔改板V2.9.2
* core.status.event.id的真正作用是影响actions.js中的_sys_keyDown_lockControl,_sys_ondown_lockControl等函数
* 本版本非h5魔塔官方版本，仅为自用魔改版
* [x] 移除了sample层以及对应的多余怪物数据
* [x] 修正了runtime.d.ts的错误
